            ...
            <div class="col-xl-12 pd-0">
              <form action="" method="post">
                <div class="form-group d-flex m-0 fs-14 clearfix">
                 <?php _back('index.php') ?>  <input type="hidden" class="form-control mr-2 fs-20" name="m_id" value="<?php echo $result['m_id']; ?>" required>
                  ...
                  <input type="text" class="form-control mr-2"  name="tab_id2" value="<?php echo $result['tab_id2']; ?>" required>
