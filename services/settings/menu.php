                ...
                <div class="col-xl-12 col-md-6 pd-0">
                  <form action="" method="post">
                    <div class="form-group d-flex m-0 fs-14 clearfix">
                      ...
                      name="m_id" value="<?php if($rested>=1){echo $id;}else{echo "";} ?>">
                      <input type="text" class="form-control mr-2 fs-20"  name="m_icon" placeholder="ປ້ອນຊື່ໄອຄອ໋ນ" >
                      <input type="text" class="form-control mr-2 fs-20"  name="m_name" placeholder="ປ້ອນຊື່ເມນູ" >
...
if(isset($_POST['onSubmit'])){
  ...
  $created=$_SQL($con,"INSERT INTO sp_menu(m_id,m_icon,m_name)VALUES('$m_id','$m_icon','$m_name')");
  if($created){
