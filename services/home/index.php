...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <?php include ('../../connection.php') ?>
    <div class="ms-content-wrapper">
      <div class="row">
        <div class="col-md-12">
          <ul class="nav nav-tabs nav-justified has-gap pb-4 btn-group" role="tablist">
            <li role="presentation" class="fs-12"><a href="#btc" aria-controls="btc" class="<?php if($_WEEK_DAY=='Mon'){echo 'active';}else{};?> show" role="tab" data-toggle="tab"> ຈັນ </a></li>
            <li role="presentation" class="fs-12"><a href="#xrp" aria-controls="xrp" class="<?php if($_WEEK_DAY=='Tue'){echo 'active';}else{};?> show" role="tab" data-toggle="tab"> ອັງຄານ </a></li>
            <li role="presentation" class="fs-12"><a href="#ltc" aria-controls="ltc" class="<?php if($_WEEK_DAY=='Wen'){echo 'active';}else{};?> show" role="tab" data-toggle="tab"> ພຸດ </a></li>
            <li role="presentation" class="fs-12"><a href="#eth" aria-controls="eth" class="<?php if($_WEEK_DAY=='Thu'){echo 'active';}else{};?> show" role="tab" data-toggle="tab"> ພະຫັດ </a></li>
            <li role="presentation" class="fs-12"><a href="#zec" aria-controls="zec" class="<?php if($_WEEK_DAY=='Fri'){echo 'active';}else{};?> show" role="tab" data-toggle="tab"> ສຸກ </a></li>
            <li role="presentation" class="fs-12"><a href="#zec" aria-controls="zec" class="<?php if($_WEEK_DAY=='Sat'){echo 'active';}else{};?> show" role="tab" data-toggle="tab"> ເສົາ </a></li>
            <li role="presentation" class="fs-12"><a href="#zec" aria-controls="zec" class="<?php if($_WEEK_DAY=='Sun'){echo 'active';}else{};?> show" role="tab" data-toggle="tab"> ອາທິດ </a></li>
          </ul>
          <h1 class="db-header-title">ຍິນດີຕ້ອນຮັບ, Anny</h1>
        </div>
