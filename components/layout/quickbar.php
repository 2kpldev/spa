    ...
    <div class="modal-content">
      ...
      <form>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-primary btn-sm has-icon" data-dismiss="modal">
            <i class="fa fa-check"></i> ບັນທຶກ
          </button>
          <button type="button" class="btn btn-outline-light btn-sm has-icon" data-dismiss="modal">
